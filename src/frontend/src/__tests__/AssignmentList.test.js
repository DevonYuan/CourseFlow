...
describe('AssignmentList', () => {
    ...
    it('shows skeleton while loading', () => {
        ...
        render(_jsx(ToastProvider, { children: _jsx(AssignmentList, { onOpenSettings: mockOnOpenSettings, onAssignmentClick: mockOnAssignmentClick }) }));
    ...
    it('shows overdue badge for overdue assignments', async () => {
        ...
        const overdueAssignment = {
            ...
            dueAt: '2020-01-01T23:59:00.000Z', // Past date
    ...
    it('renders multiple assignments', async () => {
        const assignments = [
            mockAssignments[0],
            { ...mockAssignments[0], id: '2', title: 'Assignment 2', courseName: 'MATH201' },
        ];
...
//# sourceMappingURL=AssignmentList.test.js.map