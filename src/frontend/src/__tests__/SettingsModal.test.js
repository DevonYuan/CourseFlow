...
function renderSettingsModal(props = { isOpen: true, onClose: vi.fn() }) {
    return render(_jsx(ToastProvider, { children: _jsx(SettingsModal, { ...props }) }));
}
...
function setupFetchMocks() {
    ...
    mockApi.ical.fetch.mockImplementation(async (url) => {
...
describe('SettingsModal', () => {
    ...
    describe('Settings Loading', () => {
        ...
        it('unsubscribes from settings changes when closed', async () => {
            ...
            rerender(_jsx(ToastProvider, { children: _jsx(SettingsModal, { isOpen: false, onClose: vi.fn() }) }));
...
//# sourceMappingURL=SettingsModal.test.js.map