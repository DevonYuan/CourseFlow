 ...
 */
import type { Assignment, AssignmentInput, SubTask, SubTaskInput, Note, NoteInput, PriorityOrder, PriorityOrderInput, Settings, ICalEvent } from './types.js';
/**
 ...
 */
export declare const IpcErrorCode: {
